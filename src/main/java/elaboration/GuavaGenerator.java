...
public class GuavaGenerator extends GuavaBaseVisitor<String> {
    ...
    /**
     * Gets the list of instructions generated by the generator
    ...
    /**
     * Gets the lists of instructions that have to be executed concurrently
     * @return a list of concurrent instructions
     */
    ...
    /**
     * Initialises or refreshes the instructions for the different threads
     * @param ctx a node
     * @param lastBranch the last branch statement in the code
     */
    ...
    public String visitProgram(GuavaParser.ProgramContext ctx) {
        ...
        if (result.isConc()) {
            ...
            addInstr(new Instruction.LoadConst("1", reg(ctx)));
            addInstr(new Instruction.WriteInst(reg(ctx), MemAddr.DirAddr, "0"));
            addInstr(new Instruction.WriteInst(reg(ctx), MemAddr.DirAddr, "1"));
            addInstr(new Instruction.WriteInst(reg(ctx), MemAddr.DirAddr, "2"));
    ...
    public String visitForStat(GuavaParser.ForStatContext ctx) {
        ...
        List<String> emptyRegistersBeforeForLoop = new ArrayList<>();
        emptyRegistersBeforeForLoop.addAll(emptyRegisters);
        ...
        emptyReg(ctx.expr(0));
        delNestedVar(ctx.ID());
        this.emptyRegisters = emptyRegistersBeforeForLoop;
        return null;
    }
